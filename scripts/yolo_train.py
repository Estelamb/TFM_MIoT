...
try:
    ...
    traceback.print_exc()
    print("\nTo train on your computer's GPU, please configure the environment first.")
    print("You can run the setup script:")
    print("  .\\setup_gpu_training.bat")
...
def prepare_dataset(args) -> str:
    ...
    """
    print(f"--- Starting Dataset Preparation from {args.data_dir} ---")
    ...
    try:
        ...
        print(f"Error: No classes.json file found at {args.data_dir}, please define!")
        print(e)
        return None

    # YAML Configuration Generation
    base_dir: str = os.path.basename(os.path.normpath(args.data_dir))
    parent_dir: str = os.path.dirname(os.path.normpath(args.data_dir))
    config_dir: str = os.path.join(parent_dir, "configs")
...
def main():
    ...
    if cuda_available:
        ...
        print("the CUDA-compatible PyTorch wheels (using setup_gpu_training.bat).")
    print("-" * 28 + "\n")
