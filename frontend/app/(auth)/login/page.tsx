  ...
  return (
    <div className="w-full max-w-sm mx-auto animate-fade-in px-6">
      <div className="flex flex-col items-center gap-4 mb-8">
        ...
        {/* Logo aligned with the glowing profile picture style from your portfolio */}
        <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-blue-200 to-emerald-100 dark:from-gray-700 dark:to-gray-800 p-1 shadow-xl">
          <div className="w-full h-full rounded-full bg-white dark:bg-gray-950 flex items-center justify-center border-2 border-white dark:border-gray-900">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-emerald-500 text-2xl font-bold font-mono">
              A
            </span>
          </div>
        </div>
